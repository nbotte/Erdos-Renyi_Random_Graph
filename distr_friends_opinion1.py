...
hist = np.loadtxt("Hist_500_and_0_fraction_friends_opinion1_Clustered_001-001_REC.txt")
...
plt.title('Normalized average distribution of friends with the same opinion 1\np_cl = 0.01, p_add = 0.01, p_act = 0.1, N = 1000\nStochastic block model (2 x 500), 10 x 10 averaged')
plt.savefig('Normalized_hist_fraction_friends_opinion1_Clustered_001-001_2-500_REC_av.png')
plt.show()
