...
hist = np.loadtxt("Hist_500_and_0_fraction_friends_opinion1_real_network_lastfm_REC_8003_fracRes=0_stubb=0.txt")
hist1 = np.loadtxt("Hist_500_and_0_fraction_friends_opinion1_SBM_PR_8003-005-001-000001-powerlaw_fracRes=0_stubb=0_av10x5.txt")
hist2 = np.loadtxt("Hist_500_and_0_fraction_friends_opinion1_SBM_PR_8003-0023-00001_53x151_fracRes=0_stubb=0.txt")
hist3 = np.loadtxt("Hist_500_and_0_fraction_friends_opinion1_SBM-WS_REC_8003-4-0025-00001-powerlaw_fracRes=0_stubb=0_av10x5.txt")
hist4 = np.loadtxt("Hist_500_and_0_fraction_friends_opinion1_SBM-WS_REC_8003-4-0025-00001_53x151_fracRes=0_stubb=0_av10x5.txt")
...
ax.plot(t, hist[:,2], linestyle='solid', label=r"Last.fm network")
#ax.plot(t, hist1[:,2], linestyle='solid', label=r"SBM, heterogeneous sizes")
#ax.plot(t, hist2[:,2], linestyle='solid', label=r"SBM, single size")
ax.plot(t, hist3[:,2], linestyle='solid', label=r"SBM-WS, heterogeneous sizes")
ax.plot(t, hist4[:,2], linestyle='solid', label=r"SBM-WS, single size")
...
plt.tight_layout()
plt.savefig("echo_chambers_SBM_powerlaw_vs_regular_REC.png", dpi=500)
plt.show()
