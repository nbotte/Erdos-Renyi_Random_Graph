...
#hist = np.loadtxt("Hist_500_and_0_fraction_friends_opinion1_WS_PR_10-001_fracRes=0_stubb=0_20-80.txt")
hist1 = np.loadtxt("Hist_500_and_0_fraction_friends_opinion1_WS_PR_10-006_fracRes=0_stubb=0_20-80.txt")
#hist2 = np.loadtxt("Hist_500_and_0_fraction_friends_opinion1_WS_REC_10-001_fracRes=0_stubb=0_20-80.txt")
hist3 = np.loadtxt("Hist_500_and_0_fraction_friends_opinion1_WS_REC_10-006_fracRes=0_stubb=0_20-80.txt")
...
#ax.plot(t, hist[:,2], linestyle='solid', label=r"$\beta = 0.01,\ \left<C\right> \sim 0.60$, PR")
ax.plot(t, hist1[:,2], linestyle='solid', label=r"PR")
#ax.plot(t, hist2[:,2], linestyle='solid', label=r"$\beta = 0.01,\ \left<C\right> \sim 0.60$, REC")
ax.plot(t, hist3[:,2], linestyle='solid', label=r"REC")
...
ax.set_xlabel(r"$\left<P_1^{\text{nn}}\right>$", fontsize=10)
ax.set_ylabel(r"$F_N(\left<P_1^{\text{nn}}\right>)$", fontsize=10)
#ax.set_yscale('log')
...
plt.tight_layout()
plt.savefig("echo_chambers_no_stubb_WS_10_006_20-80_PR_REC_8x7.png", dpi=500)
plt.show()
