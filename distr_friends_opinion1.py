...
hist = np.loadtxt("Hist_500_and_0_fraction_friends_opinion1_ER_PR_001_res=05.txt")
...
plt.title('Normalized average distribution of friends with the same opinion 1\nN = 1000, p = 0.01, res = 0.5\nErdos-Renyi model, 10 x 10 averaged')
plt.savefig('Normalized_hist_fraction_friends_opinion1_ER_PR_001_res=05.png')
plt.show()
