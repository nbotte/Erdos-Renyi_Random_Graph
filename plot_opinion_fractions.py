...
fractions_av = np.loadtxt('Fraction_of_opinions_1_50_50_no_stubb_paper8_active_1_one_node_fully_connected_av.txt')
...
plt.ylim(0.45, 0.55)
plt.legend(loc='best')
plt.title('Opinion fraction vs time (probabilistic model, one node), 50/50, p = 1.\nFully connected network, averaged over 20 networks')
plt.savefig('Fraction_of_opinions_1_50_50_no_stubb_paper8_active_1_one_node_fully_av.png')
plt.show()
