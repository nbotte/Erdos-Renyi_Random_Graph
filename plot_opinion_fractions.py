...
fractions_av = np.loadtxt('Fraction_of_opinions_1_50_50_no_stubb_paper8_active_1_one_node.txt')
...
plt.plot(t, fractions_av[:,1], label='Opinion 1')
...
plt.ylim(0.45, 0.55)
plt.legend(loc='best')
plt.title('Opinion fraction vs time (probabilistic model, one node), 50/50, p = 0.1')
plt.savefig('Fraction_of_opinions_1_50_50_no_stubb_paper8_active_1_one_node.png')
plt.show()
