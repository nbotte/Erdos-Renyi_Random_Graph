...
fractions_av = np.loadtxt('Fraction_of_opinions_1_20_80_no_stubb_paper8_active_01_av_good_init.txt')
...
plt.plot(t[::10], fractions_av[:,1][::10], label='Opinion 1')
plt.plot(t[::10], y[::10])
...
#plt.ylim(0.45, 0.55)
plt.legend(loc='best')
plt.title('Opinion fraction vs time (probabilistic model), 20/80, p = 0.1, p_act = 0.1\nErdos-Renyi network, averaged over 50 networks')
plt.savefig('Fraction_of_opinions_1_20_80_no_stubb_paper8_active_01_av_good_init.png')
plt.show()
