...
fractions_av = np.loadtxt('Fraction_of_opinions_WS_50_50_no_stubb_paper8_active_01_av_good_init_PR_beta-001_res-01.txt')
...
plt.plot(t[::10], fractions_av[:,1][::10], label='Opinion 1, PR')
plt.plot(t[::10], y[::10])
...
plt.savefig('Fraction_of_opinions_WS_50_50_no_stubb_paper8_active_01_av_good_init_PR_beta-001_res-01.png')
