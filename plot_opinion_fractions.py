...
fractions_av0 = np.loadtxt('Fraction_of_opinions_Clustered_cluster0_01-001_20_80_no_stubb_paper8_active_01_av_good_init.txt')
fractions_av3 = np.loadtxt('Fraction_of_opinions_Clustered_cluster3_01-001_20_80_no_stubb_paper8_active_01_av_good_init.txt')
...
axes[0].title.set_text("Opinion fraction vs time (cluster 0), 20/80\n p_cl = 0.1, p_add = 0.01, p_act = 0.1")

axes[1].plot(t[::10], fractions_av3[:,0][::10], label='Opinion 0')
#axes[1].plot(t[::10], fractions_av3[:,1][::10], label='Standard deviation')
#axes[1].plot(t, y)
axes[1].legend(loc='best')
axes[1].set_xlabel("Timesteps t")
axes[1].set_ylabel("Opinion fraction")
axes[1].set_ylim(0, 0.3)
axes[1].title.set_text("Opinion fraction vs time (cluster 3), 20/80\n p_cl = 0.1, p_add = 0.01, p_act = 0.1")
# shift subplots down:
st.set_y(0.03)
fig.subplots_adjust(bottom=0.1)

fig.tight_layout()
fig.savefig('Fraction_of_opinions_Clustered_cluster0-3_01-001_20_80_no_stubb_paper8_active_01_av_good_init.png')
plt.show()
