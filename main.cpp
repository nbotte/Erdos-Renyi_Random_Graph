...
void distr_of_friends(){
    ...
    ofstream normfile("Hist_500_and_0_fraction_friends_opinion1_WS_PR_10-001_T=02.txt");
   // ofstream varfile("Hist_500_and_0_fraction_friends_opinion1_SBM_PR_01-0001_res=0_10x100_mean_var_11_bins.txt");
    //ofstream xfile("Hist_500_and_0_fraction_friends_opinion1_WS_PR_10-001_100x10Av_xvalues.txt");
    ofstream echofile("Echo_chamber_WS_PR_10_001_T=02.txt");
...
void evolution_of_opinions(){
    ...
    ofstream opfile("Fraction_of_opinions_WS_50_50_no_stubb_paper8_active_01_av_good_init_PR_10-001_T=02.txt");
