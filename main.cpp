...
void distr_of_friends(){
   ...
   /* double x;
    ...
    for (int n = 0; n < 10; n++){
       ...
       // mod += (g.calculateModularity()/10.);
        ...
        for (int s = 0; s < 5; s++){
            ...
            g.makeRandomFractionStubborn(0., 0.); // make fraction of the nodes (0 to 1, first parameter) resistant (change how resistant they are from 0 to 1, second parameter)
    ...
    ofstream normfile("Hist_500_and_0_fraction_friends_opinion1_SBM_PR_10680-002-000005_60x178_fracRes=0_stubb=0_av10x5.txt");
    ofstream xfile("Hist_500_and_0_fraction_friends_opinion1_SBM_PR_10680-002-000005_60x178_fracRes=0_stubb=0_av10x5_xvalues.txt");
    ofstream echofile("Echo_chamber_SBM_PR_10680-002-000005_60x178_fracRes=0_stubb=0_av10x5.txt");
...
void evolution_of_opinions(){
    ...
    ofstream opfile("Fraction_of_opinions_active_01_av_good_init_SBM_PR_10680-002-000005_60x178_fracRes=0_stubb=0_av10x5.txt");
   ...
   // vector<double> commOp0Begin(clusterSizes.size()); // vector that contains the fraction of opinion 0 in each community at beginning of simulation --> also check for n, s = 1 (to see things without averaging)
    ...
    for (int n = 0; n < 10; n++){
       ...
       // g.setNodeThreshold(0.);
        cout << "Graph: " << n << endl;
        // for each network, run different simulations
        for (int s = 0; s < 5; s++){
