...
int main(){
  ...
  //  g.changeOpinions();
   // g.print();
    ...
    ofstream opfile("Fraction_of_opinions_1_50_50_no_stubb_av_paper8_active_05_long.txt");
    vector<double> fractionsA(5000);
    vector<double> fractionsB(5000); 
...
// TO DO: ckeck opinion dynamics carefully, correctly implemented? Do some more testing
