...
void distr_of_friends(){
    ...
    ofstream normfile("Hist_500_and_0_fraction_friends_opinion1_SBM_REC_8003-0023-00001_53x151_fracRes=0_stubb=0.txt");
   // ofstream varfile("Hist_500_and_0_fraction_friends_opinion1_SBM_PR_01-0001_res=0_10x100_mean_var_11_bins.txt");
    ofstream xfile("Hist_500_and_0_fraction_friends_opinion1_SBM_REC_8003-0023-00001_53x151_fracRes=0_stubb=0_xvalues.txt");
    ofstream echofile("Echo_chamber_real_network_SBM_REC_8003-0023-00001_53x151_fracRes=0_stubb=0.txt");
...
void evolution_of_opinions(){
    ...
    /*vector<int> clusterSizes = {}; // length of this vector determines the number of cluster and the elements determine the size of each cluster
    vector<double> edgeProbs = {};*/
    vector<int> clusterSizes(7); // length of this vector determines the number of cluster and the elements determine the size of each cluster
    vector<double> edgeProbs(7);
    vector<int> meanDegrees(7);
    /*double x;
    while (file >> x){
        clusterSizes.push_back(x);
        if (x < 100){
    ...
    ofstream opfile("Fraction_of_opinions_active_01_av_good_init_ER_PR_001_fracRes=0_stubb=0.txt");
...
void Av_degree(){
   ...
   /* ifstream file;
    ...
    cout << Av_degree << ' ' << mod << ' ' << modTest << ' ' << clus << ' ' << edges_tot << endl;
}
