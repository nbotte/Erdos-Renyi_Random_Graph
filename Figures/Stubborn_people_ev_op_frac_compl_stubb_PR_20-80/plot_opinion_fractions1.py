...
fractions2 = np.loadtxt('Fraction_of_opinions_active_01_av_good_init_SBM_PR_003-0008_10x100_fracRes=04_stubb=1_20-80.txt')
fractions3 = np.loadtxt('Fraction_of_opinions_active_01_av_good_init_SBM_PR_003-0008_10x100_fracRes=08_stubb=1_20-80.txt')
...
ax.errorbar(t[::50], fractions1[:,0][::50], np.sqrt(fractions1[:,2][::50]), label=r'Low mod, fracRes $=0$')
ax.errorbar(t[::50], fractions2[:,0][::50], np.sqrt(fractions2[:,2][::50]), label=r'Low mod, fracRes $=0.4$')
ax.errorbar(t[::50], fractions3[:,0][::50], np.sqrt(fractions3[:,2][::50]), label=r'Low mod, fracRes $=0.8$')
ax.errorbar(t[::50], fractions4[:,0][::50], np.sqrt(fractions4[:,2][::50]), label=r'High mod, fracRes $=0$')
ax.errorbar(t[::50], fractions5[:,0][::50], np.sqrt(fractions5[:,2][::50]), label=r'High mod, fracRes $=0.4$')
ax.errorbar(t[::50], fractions6[:,0][::50], np.sqrt(fractions6[:,2][::50]), label=r'High mod, fracRes $=0.8$')
...
plt.tight_layout()
plt.savefig("fraction_of_opinions_SBM_frac_compl_stubb_PR_20-80_8x7.png", dpi=500)
plt.show()
