...
echoSBMWS01 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_fracRes=01_stubb=1.txt")
echoSBMWS02 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_fracRes=02_stubb=1.txt")
echoSBMWS03 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_fracRes=03_stubb=1.txt")
echoSBMWS04 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_fracRes=04_stubb=1.txt")
echoSBMWS05 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_fracRes=05_stubb=1.txt")
echoSBMWS06 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_fracRes=06_stubb=1.txt")
echoSBMWS07 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_fracRes=07_stubb=1.txt")
echoSBMWS08 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_fracRes=08_stubb=1.txt")
echoSBMWS09 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_fracRes=09_stubb=1.txt")
echoSBMWS1 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_fracRes=1_stubb=1.txt")
...
errWS = [60.62, 28.62, 14.57, 10.14, 6.43, 4.88, 3.36, 2.61, 2.26, 1.65, 1.01]
...
errSBMH = [11.62, 6.86, 2.98, 2.09, 2.19, 1.32, 1.52, 1.32, 1.2, 1.21, 1.21]
...
errER = [1.74, 1.27, 0.8, 1.09, 1.03, 0.87, 0.96, 0.91, 0.69, 0.99, 1.07]
...
errSBML = [1.66, 1.74, 1.07, 0.99, 0.94, 1.16, 0.9, 1.11, 1.14, 0.94, 1.13]
...
errSBMWS = [46.93, 19.27, 11.3, 7.11, 5.52, 3.77, 2.66, 2.1, 1.33, 1.04, 0.9]
...
#ax.set_ylim(-100, 950)
ax.set_xlabel(r"$f_s$", fontsize=10)
...
plt.tight_layout()
plt.savefig("echo_chamber_vs_stubbornness_SBM_frac_compl_stubb_PR_10x8.png", dpi=500)
plt.show()
