...
ax.errorbar(mod, echo, err/10, xerr=None, c='b', ls='', marker='o', label = r'PR')
ax.errorbar(mod, echoREC, errREC/10, xerr=None, c='r', ls='', marker='o', label = r'REC')
...
plt.tight_layout()
plt.savefig("echo_chamber_vs_modularity_edge_prob_same_deg_PR_REC_10x8.png", dpi=500)
plt.show()
