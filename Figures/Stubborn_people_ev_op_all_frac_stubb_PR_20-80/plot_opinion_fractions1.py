...
fractions1 = np.loadtxt('Fraction_of_opinions_active_01_av_good_init_SBM_PR_003-0008_10x100_fracRes=0_stubb=0_20-80.txt')
fractions2 = np.loadtxt('Fraction_of_opinions_active_01_av_good_init_SBM_PR_003-008_10x100_fracRes=1_stubb=04_20-80.txt')
fractions3 = np.loadtxt('Fraction_of_opinions_active_01_av_good_init_SBM_PR_003-008_10x100_fracRes=1_stubb=08_20-80.txt')
fractions4 = np.loadtxt('Fraction_of_opinions_active_01_av_good_init_SBM_PR_01-0001_10x100_fracRes=0_stubb=0_20-80.txt')
fractions5 = np.loadtxt('Fraction_of_opinions_active_01_av_good_init_SBM_PR_01-0001_10x100_fracRes=1_stubb=04_20-80.txt')
fractions6 = np.loadtxt('Fraction_of_opinions_active_01_av_good_init_SBM_PR_01-0001_10x100_fracRes=1_stubb=08_20-80.txt')
...
ax.errorbar(t[::50], fractions1[:,0][::50], np.sqrt(fractions1[:,2][::50]), label=r'Low $Q$')
ax.errorbar(t[::50], fractions2[:,0][::50], np.sqrt(fractions2[:,2][::50]), label=r'Low $Q$')
ax.errorbar(t[::50], fractions3[:,0][::50], np.sqrt(fractions3[:,2][::50]), label=r'Low $Q$')
...
ax.errorbar(t[::50], fractions4[:,0][::50], np.sqrt(fractions1[:,2][::50]), label=r'High $Q$')
...
handles = ph + h
labels = [r"$r = 0$:", r"$r = 0.4$:", r"$r = 0.8$:"] + l
...
plt.tight_layout()
plt.savefig("fraction_of_opinions_SBM_all_frac_stubb_PR_20-80_8x7.png", dpi=500)
plt.show()
