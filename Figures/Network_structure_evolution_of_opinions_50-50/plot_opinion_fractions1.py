...
fractions1 = np.loadtxt('Fraction_of_opinions_SBM_50_50_no_stubb_paper8_active_01_av_good_init_PR_01-0001_10x100_T=0.txt')
fractions2 = np.loadtxt('Fraction_of_opinions_SBM_50_50_no_stubb_paper8_active_01_av_good_init_PR_003-0008_10x100_T=0.txt')
fractions3 = np.loadtxt('Fraction_of_opinions_SBM_active_01_av_good_init_REC_01-0001_10x100_all_res_stubb=0.txt')
fractions4 = np.loadtxt('Fraction_of_opinions_SBM_50_50_no_stubb_paper8_active_01_av_good_init_REC_003-0008_10x100_T=0.txt')
...
plt.tight_layout()
plt.savefig("fraction_of_opinions_SBM_10x100_01-0001_003-0008_50-50_PR_REC_8x7.png", dpi=500)
plt.show()
