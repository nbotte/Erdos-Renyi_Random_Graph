...
errWS = [7.56, 11.48, 10.76, 9.69, 8.02, 5.87, 4.46, 3.08, 2.12, 1.75, 1.19]
...
errSBMH = [1.61, 2.36, 2.03, 1.72, 1.76, 1.52, 1.21, 1.37, 1.63, 1.24,1.22]
echoER = np.zeros(11)
...
errER = [1.44, 1.34, 0.95, 0.98, 0.78, 0.97, 1.06, 0.98, 1.02, 1.16, 0.93]
...
errSBML = [1.84, 1.53, 1.46, 1.03, 1.17, 1.28, 1.02, 1.25, 1.02, 1.05 ,0.99]
...
errSBMWS = [5.91, 7.03, 7.27, 6.61, 5, 4.33, 2.9, 2.19, 1.68, 1.33 ,0.98]
