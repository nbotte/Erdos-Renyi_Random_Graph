...
hist = np.loadtxt("Hist_500_and_0_fraction_friends_opinion1_SBM_commOp0=05_other=50-50_REC_01-0001_10x100_T=0.txt")
hist1 = np.loadtxt("Hist_500_and_0_fraction_friends_opinion1_SBM_commOp0=05_other=50-50_REC_01-0001_10x100_T=0_random=75-25.txt")
hist2 = np.loadtxt("Hist_500_and_0_fraction_friends_opinion1_SBM_commOp0=05_other=50-50_REC_003-0008_10x100_T=0.txt")
hist3 = np.loadtxt("Hist_500_and_0_fraction_friends_opinion1_SBM_commOp0=05_other=50-50_REC_003-0008_10x100_T=0_random=75-25.txt")
...
ax.plot(t, hist[:,2], linestyle='solid', label=r"High mod, comm. distributed")
ax.plot(t, hist1[:,2], linestyle='solid', label=r"High mod, random distributed")
ax.plot(t, hist2[:,2], linestyle='solid', label=r"Low mod, comm. distributed")
ax.plot(t, hist3[:,2], linestyle='solid', label=r"Low mod, random distributed")
...
plt.tight_layout()
plt.savefig("echo_chambers_SBM_comm05_distr_REC_8x7.png", dpi=500)
plt.show()
