...
echoSBMH01 = np.loadtxt("Echo_chamber_SBM_PR_01-0001_10x100_all_res_stubb=01.txt")
echoSBMH02 = np.loadtxt("Echo_chamber_SBM_PR_01-0001_10x100_all_res_stubb=02.txt")
echoSBMH03 = np.loadtxt("Echo_chamber_SBM_PR_01-0001_10x100_all_res_stubb=03.txt")
echoSBMH04 = np.loadtxt("Echo_chamber_SBM_PR_01-0001_10x100_all_res_stubb=04.txt")
echoSBMH05 = np.loadtxt("Echo_chamber_SBM_PR_01-0001_10x100_all_res_stubb=05.txt")
echoSBMH06 = np.loadtxt("Echo_chamber_SBM_PR_01-0001_10x100_all_res_stubb=06.txt")
echoSBMH07 = np.loadtxt("Echo_chamber_SBM_PR_01-0001_10x100_all_res_stubb=07.txt")
echoSBMH08 = np.loadtxt("Echo_chamber_SBM_PR_01-0001_10x100_all_res_stubb=08.txt")
echoSBMH09 = np.loadtxt("Echo_chamber_SBM_PR_01-0001_10x100_all_res_stubb=09.txt")
echoSBMH1 = np.loadtxt("Echo_chamber_SBM_PR_01-0001_10x100_all_res_stubb=1.txt")
...
echoSBML0 = np.loadtxt("Echo_chamber_SBM_PR_003-0008_10x100_fracRes=0_stubb=1.txt")
echoSBML01 = np.loadtxt("Echo_chamber_SBM_PR_003-0008_10x100_all_res_stubb=01.txt")
echoSBML02 = np.loadtxt("Echo_chamber_SBM_PR_003-0008_10x100_all_res_stubb=02.txt")
echoSBML03 = np.loadtxt("Echo_chamber_SBM_PR_003-0008_10x100_all_res_stubb=03.txt")
echoSBML04 = np.loadtxt("Echo_chamber_SBM_PR_003-0008_10x100_all_res_stubb=04.txt")
echoSBML05 = np.loadtxt("Echo_chamber_SBM_PR_003-0008_10x100_all_res_stubb=05.txt")
echoSBML06 = np.loadtxt("Echo_chamber_SBM_PR_003-0008_10x100_all_res_stubb=06.txt")
echoSBML07 = np.loadtxt("Echo_chamber_SBM_PR_003-0008_10x100_all_res_stubb=07.txt")
echoSBML08 = np.loadtxt("Echo_chamber_SBM_PR_003-0008_10x100_all_res_stubb=08.txt")
echoSBML09 = np.loadtxt("Echo_chamber_SBM_PR_003-0008_10x100_all_res_stubb=09.txt")
echoSBML1 = np.loadtxt("Echo_chamber_SBM_PR_003-0008_10x100_all_res_stubb=1.txt")

echoER0 = np.loadtxt("Echo_chamber_real_network_ER_PR_001_fracRes=0_stubb=0.txt")
echoER01 = np.loadtxt("Echo_chamber_ER_PR_001_fracRes=1_stubb=01.txt")
echoER02 = np.loadtxt("Echo_chamber_ER_PR_001_fracRes=1_stubb=02.txt")
echoER03 = np.loadtxt("Echo_chamber_ER_PR_001_fracRes=1_stubb=03.txt")
echoER04 = np.loadtxt("Echo_chamber_ER_PR_001_fracRes=1_stubb=04.txt")
echoER05 = np.loadtxt("Echo_chamber_ER_PR_001_fracRes=1_stubb=05.txt")
echoER06 = np.loadtxt("Echo_chamber_ER_PR_001_fracRes=1_stubb=06.txt")
echoER07 = np.loadtxt("Echo_chamber_ER_PR_001_fracRes=1_stubb=07.txt")
echoER08 = np.loadtxt("Echo_chamber_ER_PR_001_fracRes=1_stubb=08.txt")
echoER09 = np.loadtxt("Echo_chamber_ER_PR_001_fracRes=1_stubb=09.txt")
echoER1 = np.loadtxt("Echo_chamber_ER_PR_001_fracRes=1_stubb=1.txt")

echoWS0 = np.loadtxt("Echo_chamber_WS_PR_10-006_all_res_stubb=0.txt")
echoWS01 = np.loadtxt("Echo_chamber_WS_PR_10-006_all_res_stubb=01.txt")
echoWS02 = np.loadtxt("Echo_chamber_WS_PR_10-006_all_res_stubb=02.txt")
echoWS03 = np.loadtxt("Echo_chamber_WS_PR_10-006_all_res_stubb=03.txt")
echoWS04 = np.loadtxt("Echo_chamber_WS_PR_10-006_all_res_stubb=04.txt")
echoWS05 = np.loadtxt("Echo_chamber_WS_PR_10-006_all_res_stubb=05.txt")
echoWS06 = np.loadtxt("Echo_chamber_WS_PR_10-006_all_res_stubb=06.txt")
echoWS07 = np.loadtxt("Echo_chamber_WS_PR_10-006_all_res_stubb=07.txt")
echoWS08 = np.loadtxt("Echo_chamber_WS_PR_10-006_all_res_stubb=08.txt")
echoWS09 = np.loadtxt("Echo_chamber_WS_PR_10-006_all_res_stubb=09.txt")
echoWS1 = np.loadtxt("Echo_chamber_WS_PR_10-006_all_res_stubb=1.txt")

echoSBMWS0 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_10x100_all_res_stubb=0.txt")
echoSBMWS01 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_10x100_all_res_stubb=01.txt")
echoSBMWS02 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_10x100_all_res_stubb=02.txt")
echoSBMWS03 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_10x100_all_res_stubb=03.txt")
echoSBMWS04 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_10x100_all_res_stubb=04.txt")
echoSBMWS05 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_10x100_all_res_stubb=05.txt")
echoSBMWS06 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_10x100_all_res_stubb=06.txt")
echoSBMWS07 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_10x100_all_res_stubb=07.txt")
echoSBMWS08 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_10x100_all_res_stubb=08.txt")
echoSBMWS09 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_10x100_all_res_stubb=09.txt")
echoSBMWS1 = np.loadtxt("Echo_chamber_SBM-WS_PR_10-001-0001_10x100_all_res_stubb=1.txt")
...
errWS = [60.62, 57.06, 49.04, 38.05, 27.33, 24.6, 16.26, 10.35, 7.41, 4.38, 1.22]
...
errSBMH = [11.62, 11.5, 7.89, 6.19, 4.23, 3.44, 2.26, 2.02, 1.69, 1.27, 1.32]
...
errER = [1.74, 2.03, 1.45, 1.52, 1.13, 1.22, 1.25, 0.96, 1.07, 0.89, 1.07]
...
errSBML = [1.48, 2.08, 1.49, 1.42, 1.34, 1.19, 0.98, 1.17, 1.23, 1.12, 1.04]
...
errSBMWS = [46.93, 40.65, 33.41, 25.66, 20.97, 15.89, 9.9, 7.31, 4.71, 3.1, 0.86]
...
plt.tight_layout()
plt.savefig("echo_chamber_vs_stubbornness_all_frac_stubb_PR_10x8.png", dpi=500)
plt.show()
