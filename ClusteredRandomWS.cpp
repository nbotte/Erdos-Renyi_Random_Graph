...
Clustered_Random_WS_Network::Clustered_Random_WS_Network(int totalNumberOfNodes, vector<int> clusterSizes, vector<double> edgeProbs, vector<int> meanDegrees, double rewireAddProbability, string type){
...
void Clustered_Random_WS_Network::makeGraph(){
...
vector<int> Clustered_Random_WS_Network::makeWattsStrogatz(int numberOfNodes, int meanDegree, double beta, double initOp0Frac, int indexStart, int clust){
...
void Clustered_Random_WS_Network::rewireEdges(vector<vector<int>> clusters){
...
void Clustered_Random_WS_Network::addEdges(vector<vector<int>> clusters){
    random_device rd; // will be used to obtain a seed for the random number engine
    mt19937 gen(rd()); // standard mersenne twister engine seeded with rd()
    uniform_real_distribution<> dis(0.0, 1.0);
...
void Clustered_Random_WS_Network::makeRandomCommunityFractionStubborn(double fractionResistant){
    random_device rd; // will be used to obtain a seed for the random number engine
    mt19937 gen(rd()); // standard mersenne twister engine seeded with rd()
    uniform_real_distribution<> dis(0.0, 1.0);
...
void Clustered_Random_WS_Network::setCommunityOpinion(double frac0, int cluster, int indexStart){
    random_device rd; // will be used to obtain a seed for the random number engine
    mt19937 gen(rd()); // standard mersenne twister engine seeded with rd()
    uniform_real_distribution<> dis(0.0, 1.0);
...
vector<double> Clustered_Random_WS_Network::countOpinionFractionCluster(int clusterNumber){
    int opinion0 = 0;
    int opinion1 = 0;
...
double Clustered_Random_WS_Network::calculateModularity(){
    int refClus = 0;
